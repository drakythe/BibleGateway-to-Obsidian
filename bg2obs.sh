...
# Apocrypha enabled version? We update the arrays being pased in
if [ "$translation" == "NRSV" ]; then
	bookarray+=(Tobit Judith "Greek Esther" Wisdom Sirach Baruch "Letter of Jeremiah" "Prayer of Azariah" Susanna "Bel and the Dragon" "1 Maccabees" "2 Maccabees" "1 Esdras" "Prayer of Manasseh" "Psalm 151" "3 Maccabees" "2 Esdras" "4 Maccabees")
	lengtharray+=(14 16 10 19 51 5 1 1 1 1 16 15 9 1 1 7 16 18)
	abbarray+=(Tob Judith "G Esther" Wis Sir Bar LoJ PoA Sus Bel "1 Mac" "2 Mac" "1 Esd" PoM 151 "3 Mac" "2 Esd" "4 Mac")
fi
